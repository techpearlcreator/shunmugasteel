...
const FALLBACK = {
  'flat-products': {
    ...
    products: [
      { id: 1, name: 'HR Coils & Sheets', slug: 'hot-rolled-coils-sheets', product_type: 'standard', brand: 'SAIL', image_url: 'hot-rolled-coils-sheets-bannerb1f5.jpg', base_price: 58500, stock_status: 'in_stock', sub_category: 'HR Coils & Sheets', description: 'Hot Rolled Coils and Sheets for structural applications.' },
      { id: 2, name: 'CR Coils & Sheets', slug: 'cold-rolled-coils-sheets', product_type: 'standard', brand: 'AMNS', image_url: '0-25mm-cold-rolled-coil-1000x1000cf88.jpg', base_price: 72000, stock_status: 'in_stock', sub_category: 'CR Coils & Sheets', description: 'Cold Rolled steel for automotive and precision fabrication.' },
      ...
      { id: 4, name: 'GC Sheets', slug: 'galvanized-corrugated-sheets', product_type: 'standard', brand: 'SAIL', image_url: 'galvanized-corrugated-sheets7d36.jpg', base_price: 80000, stock_status: 'in_stock', sub_category: 'GP/GC Sheets', description: 'Galvanized Corrugated Sheets for roofing.' },
      { id: 5, name: 'PPGL Colour Coils', slug: 'ppgl-colour-coated-coils', product_type: 'standard', brand: 'AMNS', image_url: 'Color-Coated-Coilsb58b.jpg', base_price: 95000, stock_status: 'in_stock', sub_category: 'Colour Coated', description: 'Pre-Painted Galvalume colour coated coils.' },
      { id: 6, name: 'GP Slitted Coil', slug: 'gp-slitted-coils', product_type: 'standard', brand: 'JSW', image_url: 'gp-slit-coil-952cf2f.jpg', base_price: 87000, stock_status: 'in_stock', sub_category: 'Slitted Coils', description: 'Galvanized Plain slit coils cut to specified widths.' },
      { id: 7, name: 'CR Slitted Coil', slug: 'cr-slitted-coils', product_type: 'standard', brand: 'Evonith', image_url: '0-25mm-cold-rolled-coil-1000x1000cf88.jpg', base_price: 74000, stock_status: 'in_stock', sub_category: 'Slitted Coils', description: 'Cold Rolled slit coils for precision applications.' },
    ],
  },
  'roofing-products': {
    ...
    products: [
      { id: 8, name: 'Decking Sheets', slug: 'steel-decking-sheets', product_type: 'custom', brand: 'Evonith', image_url: 'decking-sheets-17e37.jpg', base_price: null, stock_status: 'in_stock', sub_category: 'Decking Sheets', description: 'Steel deck sheets for composite flooring.' },
      { id: 9, name: 'PUF Panels', slug: 'puf-sandwich-panels', product_type: 'custom', brand: 'JSW', image_url: 'PUF Panels8be3.png', base_price: null, stock_status: 'in_stock', sub_category: 'Insulated Panels', description: 'Polyurethane Foam insulated sandwich panels.' },
      { id: 10, name: 'UPVC Sheets', slug: 'upvc-roofing-sheets', product_type: 'custom', brand: 'JSW', image_url: 'UPVC Sheet46e3.png', base_price: null, stock_status: 'in_stock', sub_category: 'Transparent Sheets', description: 'Unplasticised PVC sheets for roofing and skylights.' },
      { id: 11, name: 'Polycarbonate Sheets', slug: 'polycarbonate-roofing-sheets', product_type: 'custom', brand: 'SAIL', image_url: 'polycarbonate-sheets-1b014.jpg', base_price: null, stock_status: 'in_stock', sub_category: 'Transparent Sheets', description: 'High-impact polycarbonate sheets for skylights.' },
      { id: 12, name: 'Purlin', slug: 'z-c-purlin', product_type: 'custom', brand: 'AMNS', image_url: 'purlinc517.jpg', base_price: null, stock_status: 'in_stock', sub_category: 'Structural', description: 'Z and C Purlins for roof and wall cladding systems.' },
    ],
  },
  'accessories': {
