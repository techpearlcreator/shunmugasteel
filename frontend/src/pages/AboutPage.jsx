          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div>
              ...
              <div className="mt-8 flex gap-4 flex-wrap">
                ...
                <Link to="/contact" className="inline-block px-6 py-3 rounded-lg font-semibold border border-gray-300 text-gray-600 hover:border-gray-400 text-sm" style={{ marginLeft: '20px' }}>Get in Touch</Link>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-10 md:gap-12 items-center">
            {Object.entries(BRAND_LOGOS).map(([key, file]) => (
              <img key={key} src={cdnImg(file)} alt={key} className="h-40 object-contain grayscale hover:grayscale-0 transition-all" style={{ padding: '40px' }} onError={(e) => { e.target.style.display = 'none' }} />
            ))}
          </div>
